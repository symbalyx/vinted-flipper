...
python3 tools/retire.py RIVIERE_70_ADAPTATION_ROR_UPDATED.bbmodel E0.bbmodel tools/a_supprimer.txt
echo "--- voile (profil C) ---"
...
echo "--- corps : queue droite et epaisse, pattes plus massives ---"
python3 tools/corps.py E1c.bbmodel E1d.bbmodel
echo "--- nageoires (main, avant-bras, orteils, tibia) ---"
python3 tools/nageoires.py E1d.bbmodel E2.bbmodel
echo "--- z-fighting ---"
...
echo "--- texture d apres la reference ---"
python3 tools/texture.py FINAL4.bbmodel FINAL5.bbmodel
